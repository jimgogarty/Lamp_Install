...
#UPDATE , NEED TO CHANGE HOW IP ADDRESS ARE ASSIGNED ON NEW  OS, 12/06/2022
...
clear
echo "============================"
echo "Connect your Device to your network via a ethernet cable"
...
#configure to allow SSH and http and ftp
...
echo""
echo ""
echo "Your Fire wall has been configured to allow SSH, HTTP and access form other programs\nsudch as Smaba, FTP ect."
echo "To View th status of your Fire wall enter the command \"sudo ufw status numbered \"."
read -p "Press enter to continue and reboot your server"
